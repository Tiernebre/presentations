      ...
      {({ checked }) => (
        <div
          className={classNames(
            "bg-green-100 w-30 h-15 rounded-lg flex items-center justify-center font-bold cursor-pointer",
            {
...
export const SurveyFormRadioGroup = ({ value, onChange }: RadioGroupProps) => {
  return (
    <RadioGroup value={value} onChange={onChange}>
      <RadioGroup.Label>
        On a rating from 1-5, how would you rate this talk?
      </RadioGroup.Label>
      <div className="flex items-center justify-center mt-5 lg:(space-x-5) <lg:(flex-col space-y-5)">
